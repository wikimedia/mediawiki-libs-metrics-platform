...
QUnit.test( 'constructor() - does not fetch stream configs when they are given', function ( assert ) {
	var fetchStreamConfigsSpy = sandbox.spy( integration, 'fetchStreamConfigs' );
	...
	assert.strictEqual( fetchStreamConfigsSpy.callCount, 0, 'fetchStreamConfigs() should not be called' );
