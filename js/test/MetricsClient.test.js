...
var enqueueEventStub = sinon.stub( integration, 'enqueueEvent' );
var logWarningStub = sinon.stub( integration, 'logWarning' );
var onSubmitStub = sinon.stub( integration, 'onSubmit' );
